...
public class ClienteEspecialista extends Cliente implements IComentarista {
     ...
     */
    public ClienteEspecialista(String nomeCompleto, String nomeDeUsuario, String senha)
            throws ClienteInvalidoException {
        super(nomeCompleto, nomeDeUsuario, senha);
    }

    /**
     * Implementa o método da interface IComentarista e chama o método da mídia para
     * setar o comentário
     * 
     ...
     * @throws AvaliacaoInvalidaException propaga a exceção se houver valores
     *                                    inválidos
     */
    @Override
    public void comentar(String comentario, IAssistivel midia, String nomeUsuario) throws AvaliacaoInvalidaException {
