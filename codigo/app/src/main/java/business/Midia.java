...
/**
 * Construtor da classe Midia que recebe um id e um nome para criar um objeto Midia.
 * O genero e idioma são selecionados aleatoriamente entre as opções disponíveis na classe.
...
/**
 * Define um novo idioma para este objeto, se a string de entrada tiver um comprimento maior que zero.
