...
public class Filme extends Midia implements ISalvavel {
     ...
     * @param duracao essa é a duração do filme em minutos, sendo que ela deve ter mais de 1 minuto
     */
    ...
    /**
     * Esse método é para receber os dados do filme formatados para colocar no arquivo
     */
    @Override
