...
public class Filme extends Midia {
     ...
     *                mais de 1 minuto
     * @throws MidiaInvalidaException propaga exceção se a duração do filme for menor que 1 minuto
     */
    ...
    /**
     * Esse método implementa o método da interface ISalvavel é para receber os dados do filme formatados para colocar no
     * arquivo
